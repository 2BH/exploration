...
@click.option('--record_video', default=1, type=int, help='Whether to record video')
...
def main( gage_topk_init, gage_eta1, gage_eta2, optim_reward,
    ...
    rec_interval, video_length, log_dsc_verbose, env_render, use_status_predictor, save_freq, model_path, deterministic,
    n_eval_episodes
):
